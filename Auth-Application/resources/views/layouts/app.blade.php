...
<body>
    <header class="px-4 py-2 shadow">
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                <button data-messages class="p-3 mr-2 focus:outline-none hover:bg-white-900 hover:rounded-md" typle="button">
                ...
                <button data-notifications class="p-3 mr-3 focus:outline-none hover:bg-white-900 hover:rounded-md" typle="button">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-white-900 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md': open }">
                    ...
                    <a><span class="ml-4 text-sm hidden md:inline-block" href="{{ route('login') }}"></a></span>
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-white-900 border-r rtl:border-r-0 rtl:border-l dark:bg-white-900 dark:border-white-700">
            <div class="sidebar text-center bg-white-900">
                ...
                <div class="p-2.5 flex items-center rounded-md px-4 duration-300 cursor-pointer bg-white-700 text-black bg-gray-300">
                    <i class="bi bi-search text-sm"></i>
                    <input type="text" placeholder="Search" class="text-[15px] ml-4 w-full bg-transparent focus:outline-none" />
                </div>
                <a href="{{ route('admin/home') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-gray-900 text-white">
                ...
                <a href="{{ route('admin/profile') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Admin Profile</span>
                    </div>
                </a>
                <a href="{{ route('logout') }}">
