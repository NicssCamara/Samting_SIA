        ...
        <nav class="bg-transparent shadow">
                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <div class="ml-10 flex items-baseline space-x-4">
                            <a href="{{ url('/') }}" class="text-white px-3 py-2 rounded-md text-sm font-medium 
                            @if($isHomePage) bg-blue-900  @else hover:bg-blue-900 hover:text-blue-100 focus:bg-blue-700 focus:text-blue-100 @endif">Home</a>
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <a href="#" class="bg-gray-800 text-white block px-3 py-2 rounded-md text-base font-medium">Home</a>
