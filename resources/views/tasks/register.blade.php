        ...
        <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div class="max-w-md mx-auto">
            ...
            <div class="divide-y divide-gray-200">
              <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-sm sm:leading-7">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                    <input autocomplete="off" name="username" type="username" placeholder="Enter your name" id="username" class="block w-full rounded-full rounded-md border border-gray-300 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 py-1 px-9 text-gray-500" required/>
              ...
              <div class="relative">
                ...
                <div class="relative">
                <input autocomplete="off" name="confirm-password" type="password" placeholder="Confirm your password" id="password" class="block w-full rounded-full rounded-md border border-gray-300 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 py-1 px-9 text-gray-500" required/>
                <i class="px-2 absolute top-1/2 left-2 transform -translate-y-1/2 fas fa-lock" style="color: slategray;"></i>
              </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <!--Login-->
              <div>
                <p class="mt-8 text-xs">Already have an account? <a href="#" class="text-blue-500 hover:text-blue-700 font-semibold">Login Here</a></p>
              </div>
    ...
    <script>
        window.onload = function() {
          document.getElementById("login-form").addEventListener("submit", function(event) {
            ...
            if (username === "nikol" && password === "123") {
